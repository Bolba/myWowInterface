...
-- appearence
	["font"] = "Interface\\Addons\\xCT\\pixel_large.ttf",	-- "Fonts\\ARIALN.ttf" is default WoW font.
	["fontsize"] = 8,
	["fontstyle"] = "OUTLINE,MONOCHROME",	-- valid options are "OUTLINE", "MONOCHROME", "THICKOUTLINE", "OUTLINE,MONOCHROME", "THICKOUTLINE,MONOCHROME"
	["damagefont"] = "Interface\\Addons\\xCT\\pixel_large.ttf",	 -- "Fonts\\FRIZQT__.ttf" is default WoW damage font
	["damagefontsize"] = "8",	-- size of xCT damage font. use "auto" to set it automatically depending on icon size, or use own value, 16 for example. if it's set to number value icons will change size.
